...
class Stage2(Consumer):
    ...
    def pre_action(self, to):
        ...
        #SIGN IN TO ACCOUNT ON CONFLUENCE PAGES
    def main_action(self, to):
        ...
        run_kw("click_sign_in_jira")
        download_link = run_kw("get_download_link")
        run_kw("download_jira", download_link)
        run_kw("send_slack_message", payload["domain"])
        run_kw("close_jira")
